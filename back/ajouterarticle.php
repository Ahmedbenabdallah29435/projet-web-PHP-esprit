        ...
        <div class="d-flex justify-content-center">
			...
			<div class="pt-4">
				   <div class="input-group mb-2">
                        <div class="input-group-prepend">
                            <div class="input-group-text bg-warning"><i class="	fa fa-cubes"></i></div>
                        </div>
					   <select name="type" id="type" class="form-control"  >
					     <option value="select">votre choix&emsp;&emsp;&emsp;&emsp;&emsp;</option>
						 <option>ARTICLE DE RECHERCHE </option>
						 <option>GUIDE </option>
						 <option> ARTICLE THEORIQUE</option> 
						 <option>CRITITQUE</option>
						 <option>Article sur une Promotion</option>
						 <option>Article sur un evenement</option>
						</select>
                ...
                <div class="pt-4">
				   <div class="input-group mb-2">
                        <div class="input-group-prepend">
                            <div class="input-group-text bg-warning"><i class='fa fa-align-left'></i></div>
                        </div>
						<textarea rows="4" cols="50" name="description" id="description" value="" class="form-control" placeholder="description" required></textarea>
                     </div>  
            ...
            <br><div class="col-md-5"><br>&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;<td>Saisir Nom :<td></div>
                    <div class="pt-4">
					   <div class="input-group mb-2">
                        <div class="input-group-prepend">
                            <div class="input-group-text bg-warning"><i class='fa fa-plus-square'></i></i></div>
                        </div>
                        <input type="text" name="nom" id="nom" value="" class="form-control" placeholder="Nom Article" required>
                     </div>  
                    </div>
                </div>
				<br><div class="col-md-5"><br>&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;<td>Saisir categorie :<td></div>
                    <div class="pt-4">
					   <div class="input-group mb-2">
                        <div class="input-group-prepend">
                            <div class="input-group-text bg-warning"><i class='fa fa-bookmark'></i></i></div>
                        </div>
				...
				<div class="pt-4">
						...
						<div class="input-group mb-2">
                        <div class="input-group-prepend">
                            <div class="input-group-text bg-warning"><i class='fa fa-file-image-o'></i></div>
                        </div>
           ...
           <br>
                ...
                <div class=" ">
						<button name="create" data-toggle="tooltip" data-placement="bottom" title="Envoyer" class="btn btn-success" id="btn-create" onclick="return verif1();" ><i class='fa fa-plus-square'></i></button>

					    <?php buttonElement("btn-read","btn btn-primary","<i class='fa fa-refresh'></i>","read","data-toggle='tooltip' data-placement='bottom' title='Actualiser'"); ?>
