<?PHP
   ...
   if(isset($_POST['choix']) )
	...
	$allusers =$AnimauxC->recherchercategorie($_POST['Search']) ;
	}

		if  ($_POST['choix']=='sex'){
			$AnimauxC=new AnimauxC();
        $allusers =$AnimauxC->recherchersex($_POST['Search']) ;
		}
...
<div class="agile3-grids">	
		...
		<li ><a href="ajouterarticle.php"><em class="fa fa-plus-square">&nbsp;</em>Ajouter Article</a></li>
			<li><a href="article.php"><em class="fa fa-book-open">&nbsp;</em> Afficher Article</a></li>
