...
if (
    ...
    && isset($_POST['DemAnnulation'])
        ...
        if(
            ...
            $C1 = new Commandes(0,$_POST['paiment'],0);
            $CO->modifierCommande($C1,$_POST['id']);
                            ...
                            <nav class="main-menu navbar-expand-lg">
                                ...
                                <div class="navbar-collapse collapse clearfix">
                                    <ul class="navigation clearfix">
										...
										<li ><a href="AjouterCommande.php">Return</a></li>
			...
			<div class="shopper-info">
				<p>Modifier Commande</p>
							<form action="" method="POST">
                                <input type="number" name="id" id="id" placeholder="ID Commande"required> 
                                ...
                                <select name="paiment" id="paiment" required>
                                    ...
                                    <br>
                                    <br>                              
                                    <select name="DemAnnulation" id="DemAnnulation"required>
                                        <option>-- Voulez-vous Annuler la Commande? --</option>
										<option>OUI</option>
                                        <option>NON</option>
                                    </select>
