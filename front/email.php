		...
		<div class="container">
            ...
            <div class="col-lg-7 text-center">
                ...
                <hr class="star-primary">
						...
						<input type="text" name="name" class="btn" placeholder="[Your Name]" required>
						<br>
                        <br>
                        <input type="email" name="email" class="btn" placeholder="[Your Email]" required>
                        <br>
                        <br>
                        <textarea name="message" class="btn btn1"  rows="5" placeholder="vous êtes invité(e) ''par name'' pour lire notre article veuillez consulter notre site web" readonly></textarea>
                ...
                <br>
                    <br>
				<a href="article.php">	<button class="btn btn1">back</button></a>
