...
<!-- Mirrored from azim.commonsupport.com/Poopet/index.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 27 Apr 2021 11:12:14 GMT -->
<head>
<meta charset="utf-8">
...
<body class="boxed_wrapper">
                            ...
                            <nav class="main-menu navbar-expand-lg">
                                ...
                                <div class="navbar-collapse collapse clearfix">
                                    <ul class="navigation clearfix">
                                        ...
                                        <li class=" current"><a href="animaux.php">Animaux</a></li>
                                    </ul>
                                </div>
                            </nav>
                        </div>
            ...
            <div class="slide" style="background-image:url(images/main-slider/slider-1.jpg)">
                <div class="container">
                    <div class="content-box">
                        <div class="top-text">Trusted Pet Grooming & Care Center</div>
                        <h1>We take Care your pets</h1>
                        <div class="slider-btn"><a href="gallery.html" class="theme-btn">View Projects</a></div>
                    </div>
                </div>
            </div>
            ...
            <div class="row">
                <div class="col-lg-6 col-md-12 col-sm-12 content-column">
                    <div class="content-box centred">
                        <div class="sec-title">
                            <div class="top-title">Welcome to Poopet</div>
                            <h1>Your Pets are in Good Hands</h1>
                        </div>
                        <div class="text">
                            <p>There are many variations of passages of available but the majority have suffered alteration in some form, by injected hu randomised words which don look slightly believable.</p>
                        </div>
                        <div class="lower-content">
                            <div class="icon-box"><i class="flaticon-phone-call"></i></div>
                            <div class="text">Call us now for help</div>
                            <h2><a href="tel:+886668880000">666 888 0000</a></h2>
                        </div>
                    </div>
                </div>
                <div class="col-lg-6 col-md-12 col-sm-12 image-column">
                    <div class="image-box wow fadeInRight" data-wow-delay="00ms" data-wow-duration="1500ms">
                        <figure class="image"><img src="images/resource/welcome-1.png" alt=""></figure>
                    </div>
                </div>
            </div>
        </div>
    ...
    <!-- takecare-section -->
    <section class="takecare-section black-bg centred">
        <div class="container">
            <div class="sec-title">
                <div class="top-title">We Love These Pets</div>
...
<?PHP
                    ...
                    $listeanim=$animal1c->afficherAnimal();
                    ?>
                    

<div class="content home">
	<CENTER><h2>Gallery</h2></CENTER>
<CENTER>	<p>Welcome to the Gallery page, you can view the list of Animals below.</p> </CENTER>
	<br>
	<div class="images">
	
	 <?php	foreach($listeanim as $row){ ?>
	 ...
	 <div class="col-lg-4 col-md-6 col-sm-12 news-column">
                    <div class="news-block-one wow fadeInLeft" data-wow-delay="300ms" data-wow-duration="1500ms">
                        ...
                        <figure class="image-box"><a href="#"><img class="" src="<?php echo $row['image'];?>" style="width:500; height:500;"></a></figure>
                        <div class="lower-content">
						<h3> Name : <?PHP echo $row['name']; ?></h3>
                            <ul class="info-box">
                                <li>Age : <?PHP echo $row['age']; ?></li>
								<br>
                                <li><p>Color :<?PHP echo $row['couleur']; ?></p></li>
                            </ul>
                            
                            
                            <div id="center_button">
    <button class="theme-btn" onclick="location.href='mail.php'">Adoption Request</button>
...
<form action="animaux.php?id=1#position" method="POST" target="_self">	
<div id="position">
</div>
				<CENTER>
  ...
  //$C1->setNom($_POST['nomc']);

	
    echo "<option value='". $row['nomc'] ."'>" .$row['nomc'] ."</option>";  // displaying data in option menu
...
<?php    include "controller/produitC.php";
                    ...
                    $listeprod=$prod1c->afficher1($option);
?>
	...
	<div class="images">
	 ...
	 <div class="col-lg-4 col-md-6 col-sm-12 news-column">
                    <div class="news-block-one wow fadeInLeft" data-wow-delay="300ms" data-wow-duration="1500ms">
                        ...
                        <figure class="image-box"><a href="#"><img class="images" src="<?php echo $row['image'];?>" style="width:500; height:500;"></a></figure>
                        <div class="lower-content">
						<h3> Name : <?PHP echo $row['noma']; ?></h3>
                            <ul class="info-box">
                                <li> reference : <?PHP echo $row['ida']; ?></li>
								<br>
                                <li><p>Categorie :<?PHP echo $row['nomc']; ?></p></li>
                            </ul>
                            
                            
                            <div id="center_button">
    <button class="theme-btn" onclick="location.href='index.html'">Adoption Request</button>
