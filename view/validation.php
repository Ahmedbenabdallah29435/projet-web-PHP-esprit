      ...
      <div class="card">
                ...
                <div class="right">
                  <h2 class="name h2-validation"><?PHP echo $user['Nom']; ?> <?PHP echo $user['Prenom']; ?></h2>
                   ...
                   <div class="interests">
                  <p class="interests_item span-validation"><?PHP echo $user['Date_de_naissance']; ?></p>
                  <p class="interests_item span-validation"><?PHP echo $user['Adresse']; ?></p>
                  
                   
                    <p class="interests_item span-validation"><?PHP echo $user['Login']; ?></p>
                    <p class="interests_item span-validation"><?PHP echo $user['Email']; ?></p>
                    <p class="interests_item span-validation"><?PHP echo $user['Role']; ?></p>
                  </div>
