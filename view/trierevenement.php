<?PHP
	...
	$listeUsers=$event->trierevenement();
...
<script type="text/javascript" src="js/jquery.basictable.min.js1"></script>
					...
					<div class="w3l-table-info">
					  ...
					  <div style="position: absolute; width: 949px; height: 518px; z-index: 1; left: 10px; top: 15px" id="layer1">
                        ...
                        <tbody>
						   ...
						   <a class="" href="trierevenement.php?id=<?php echo $event['id']; ?>">trier </a>
						</table>
					</div>
					</div>
				  <code class="js">
